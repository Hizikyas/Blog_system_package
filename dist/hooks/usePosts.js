        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    if (error)
                        throw error;
                    return [2 /*return*/, { posts: data, total: count }];
            }
        });
    }); };
    var _a = useSWR("posts-".concat(page, "-").concat(limit), fetcher), data = _a.data, error = _a.error, isLoading = _a.isLoading, mutate = _a.mutate;
    return {
